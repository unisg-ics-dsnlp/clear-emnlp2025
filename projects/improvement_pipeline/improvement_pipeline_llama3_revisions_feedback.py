...
#     trust_remote_code=False,
#     use_vllm=False,
#     improve_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_improved_revision1.json',
#     cleaned_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_cleaned_revision1.json',
#     format_func=llama3_format_func,
#     use_feedback=True
# )
# pipeline.improve_arguments()
...
#     trust_remote_code=False,
#     use_vllm=False,
#     improve_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_improved_revision2.json',
#     cleaned_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_cleaned_revision2.json',
#     format_func=llama3_format_func,
#     use_feedback=True
# )
# pipeline.improve_arguments()
...
pipeline = ArgumentImprovementPipeline(
    ...
    trust_remote_code=False,
    use_vllm=False,
    improve_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_improved_revision3.json',
    cleaned_out_file_path='improved_out/REVISIONS_FEEDBACK/llama3_nemotron_cleaned_revision3.json',
    format_func=llama3_format_func,
    use_feedback=True
)
pipeline.improve_arguments()
