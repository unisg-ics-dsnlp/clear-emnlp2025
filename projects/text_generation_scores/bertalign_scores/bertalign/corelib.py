...
# if you get a weird error related to not finding packages, run the code with cache=False, then set it back to cache=True
# i had to fiddle around with relative imports to get stuff working, this probably broke something
@nb.jit(nopython=True, fastmath=True, cache=True)
